...
import {
  Box, Flex, Button, CanvasWrapperFront, CanvasWrapperLoad,
} from './styles';
import {
    ...
    <Box>
          ...
          <Box ml="30px">
            ...
            <Flex>
              <Flex flexDirection="column" alignItems="center">
                <Button onClick={() => setShirtColorState('blue')} color="blue">
                  Blue
                </Button>
              </Flex>

              <Flex flexDirection="column" alignItems="center">
                <Button onClick={() => setShirtColorState('green')} color="green">
                  Green
                </Button>
              </Flex>

              <Flex flexDirection="column" alignItems="center">
                <Button onClick={() => setShirtColorState('red')} color="red">
                  Red
                </Button>
              </Flex>

              <Flex flexDirection="column" alignItems="center">
                <Button onClick={() => setShirtColorState('black')} color="black">
                  Black
                </Button>
              </Flex>

              <Flex flexDirection="column" alignItems="center">
                <Button onClick={() => setShirtColorState('white')} color="white">
                  White
                </Button>
              </Flex>
            </Flex>
      ...
      <Flex justifyContent="center">
        ...
        <Box mr="20px">
          <Button
            onClick={() => {
              localStorage.setItem('savedFrontDrawing', front.getSaveData());
              localStorage.setItem('savedBackDrawing', back.getSaveData());
            }}
          >
            Save
          </Button>
        ...
        <Box>
          <Button
            onClick={() => {
              toggleCanvasDisplay();
              loadableFrontCanvas.loadSaveData(localStorage.getItem('savedFrontDrawing'))
                && loadableBackCanvas.loadSaveData(localStorage.getItem('savedBackDrawing'));
            }}
          >
            LOAD
          </Button>
